...
func Build(
	...
	return func(context packit.BuildContext) (packit.BuildResult, error) {
		...
		if val, ok := os.LookupEnv("RAILS_ENV"); ok {
			assetsLayer.LaunchEnv.Default("RAILS_ENV", val)
		} else {
			assetsLayer.LaunchEnv.Default("RAILS_ENV", "production")
			os.Setenv("RAILS_ENV", "production")
		}
		if val, ok := os.LookupEnv("RAILS_SERVE_STATIC_FILES"); ok {
			assetsLayer.LaunchEnv.Default("RAILS_SERVE_STATIC_FILES", val)
		} else {
			assetsLayer.LaunchEnv.Default("RAILS_SERVE_STATIC_FILES", "true")
			os.Setenv("RAILS_SERVE_STATIC_FILES", "true")
		}
